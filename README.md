...
```
WHEN distance from <phone> to <location> is less than 500 meter" THEN ...
WHEN route from <phone> to <location> by car is less than 500 meter THEN ...
WHEN eta of <phone> at <location> on food is less than 5 minutes THEN ...
